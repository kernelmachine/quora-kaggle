...
class Config(object):
    def __init__(self, network, n_train_samples, n_validation_samples, n_epochs, batch_size, embedding_matrix, 
                 embedding_dim, train_x1, train_x2, logdir, contrastive, save_embedding, save_train_data):
        ...
        self.model = lambda x : BuildSiamese(x) 
        self.build_network = {
...
if __name__ == '__main__':
    ...
    config = Config(network="siamese_stacked_fc",
    ...
    Run().run_siamese('data/train.csv', config)
